...
<body>
  ...
  <nav class="navbar navbar-expand-lg bg-white fixed-top d-flex justify-content-cente">
    <div class="container ">
      <!--logo-->
      <a href="../index.php"><img src="../img/logo.png" width="137px" height="43px" alt="jobspot" /></a>
    </div>
    </div>
    </div>
  </nav> <!--main content-->
  ...
  <footer class="bg-white p-4 text-muted fixed-bottom">
    <div class="container">
      ...
      <div class="d-flex flex-column align-items-center justify-content-cente mt-3">
        ...
        <!--copyrights-->
        <div class="d-flex">
          <a class=" " href="../index.php"><img src="../img/logo.png" width="58px" height="16px" alt="jobspot"
              class="mb-2" /></a>
