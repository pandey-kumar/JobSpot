...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white fixed-top">
        <div class="container">
            ...
            <a class="navbar-brand" href="#"><img src="img/logo.png" width="150px" height="70px" alt="JobSpot" /></a>
            ...
            <div class="carousel-item active">
                ...
                <div class="container">
                    <div class="carousel-caption text-left" tyle="color: blue;">
                        <h1><img class="img-fluid lgo" src="img/logo.png" height="300px" width="700px" alt="jobSpot" /></h1>
                        <h1 class="text-dark">Take You Ahead</h1>
    ...
    <div class="container marketing p-3">
        ...
        <div class="row mt-4">
            <div class="col-lg-4" style="text-align: center;">
                ...
                <p class="text-center">At JobSpot, we understand that finding the right job can be a challenging
            ...
            <div class="col-md-7 d-flex align-items-center justify-content-cente">
                <div>
                    <h2 class="featurette-heading">Our Story : <span class="text-muted">Driven by Passion and
                            Purpose.</span></h2>
                    <p class="lead"> JobSpot was born out of a passion for connecting talented individuals with
    ...
    <footer class="bg-white p-4 text-muted ">
        <div class="container">
            ...
            <div class="d-flex flex-column align-items-center justify-content-cente mt-3">
                ...
                <!--copyrights-->
                <div class="d-flex">
                    <a class=" " href="#"><img src="img/logo.png" width="58px" height="16px" alt="JobSpot"
                            class="mb-2" /></a>
